...
// ANSWER: Either n or 0 depening on whether you count the initial input.
//the slides call this space:0
...
// ANSWER: O(n) worst case the number you are looking at is the end of the array

// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER: constant complexity, or 3
...
// ANSWER:O(1).  This runs 5 times 

// Q: What is the space complexity of this function?
// ANSWER: 1, the only variable declared is i
...
// Q: What is the space complexity of this function?
// ANSWER:O(1) one variable declared
...
// Q: What is the space complexity of this function?
// ANSWER: 2 or constant, i and j are defined
...
// ANSWER: 0.  no variables declared
...
function arrInception(parentArr) {
  ...
  // Q: What is the space complexity of this function?
  // ANSWER:worst case is n, the length of the longest sub array
...
// ANSWER:No.  The first function has a space complexity of 26+n.
//the second function has a space complexity of at max 27.  


// Q: What is the space complexity of each? 
// ANSWER - countLetters: 26+n
// ANSWER - countLettersRoundTwo: 27


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: Function number one creates a new array of length equal to the input string.
//   Function two will create an array of size = to the number of different letters in the string.  which 
//will be at most 26, there is an additional variable creation in the for loop
